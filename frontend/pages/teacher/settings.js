...
export default function TeacherSettingsPage() {
  ...
  const features = [
    ...
    { key: "update-profile", label: "Update Profile", icon: <FaUserEdit style={{ fontSize: 36, marginBottom: 10, color: '#1e3c72' }} />, desc: "Edit your profile information", ref: updateProfileRef, action: () => window.location.href = "/teacher/profile" },
      ...
      <div style={{ padding: 48, maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 60 }}>
          ...
          <div ref={notificationSettingsRef} style={{ display: activeFeature === "notification-settings" ? 'block' : 'none', background: '#fff', borderRadius: 16, boxShadow: "0 2px 8px rgba(30,60,114,0.08)", padding: 32, marginBottom: 32 }}>
            ...
            {notifSettings && notifSettings.announcements && <div style={{ color: '#28a745', marginTop: 10 }}>Announcements badge will be shown.</div>}
          </div>
