    ...
    <div style={{ minHeight: '100vh', width: '100vw', background: '#f7f8fa', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        ...
        <form onSubmit={otpSent ? handleSubmit : handleSendOtp} style={{ width: '100%' }}>
          <input type="text" name="name" placeholder="Student Name" value={form.name} onChange={handleChange} required disabled={otpSent} style={{ width: '100%', padding: '12px 14px', marginBottom: 14, borderRadius: 8, border: '1.5px solid #e0e0e0', fontSize: '1rem', background: '#f7f8fa' }} />
          ...
          <input type="text" name="school" placeholder="School (optional)" value={form.school} onChange={handleChange} disabled={otpSent} style={{ width: '100%', padding: '12px 14px', marginBottom: 14, borderRadius: 8, border: '1.5px solid #e0e0e0', fontSize: '1rem', background: '#f7f8fa' }} />
          <input type="text" name="class" placeholder="Class" value={form.class} onChange={handleChange} required disabled={otpSent} style={{ width: '100%', padding: '12px 14px', marginBottom: 14, borderRadius: 8, border: '1.5px solid #e0e0e0', fontSize: '1rem', background: '#f7f8fa' }} />
          {!otpSent ? (
            ...
            <>
              ...
              <div style={{ position: 'relative', marginBottom: 14 }}>
                <input type={showPassword ? 'text' : 'password'} name='password' placeholder='Password' value={form.password} onChange={handleChange} required style={{ width: '100%', padding: '12px 14px', borderRadius: 8, border: '1.5px solid #e0e0e0', fontSize: '1rem', background: '#f7f8fa' }} maxLength={30} disabled={otpTimer <= 0} />
