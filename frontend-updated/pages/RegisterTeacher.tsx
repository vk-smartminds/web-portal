  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f7f8fa] px-4">
      <div className="w-full max-w-md bg-white rounded-2xl p-8 shadow-lg flex flex-col items-center relative">
        <div className="text-2xl font-bold text-[#222f5b] mb-2">Teacher Registration</div>
        <form onSubmit={otpSent ? handleSubmit : handleSendOtp} className="w-full">
          <input type="text" name="name" placeholder="Teacher Name" value={form.name} onChange={handleChange} required disabled={otpSent} className="w-full px-4 py-3 mb-3 rounded-lg border border-gray-200 bg-[#f7f8fa] text-base" />
          ...
          {!otpSent ? (
            ...
            <>
              ...
              <div className="relative mb-3">
                <input type={showPassword ? 'text' : 'password'} name='password' placeholder='Password' value={form.password} onChange={handleChange} required className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-[#f7f8fa] text-base pr-10" maxLength={30} />
